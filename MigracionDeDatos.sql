...
TIPO_AUTO_CODIGO INT,
TIPO_MOTOR_CODIGO INT NOT NULL,
TIPO_CAJA_CODIGO INT NOT NULL,
TIPO_TRANSMISION_CODIGO INT NOT NULL,
FABRICANTE_CODIGO INT NOT NULL
);
...
FOREIGN KEY (TIPO_CAJA_MODELO) REFERENCES UNIX.TipoCaja(TIPO_CAJA_CODIGO);
...
INSERT INTO UNIX.Compra co (COMPRA_NRO,COMPRA_FECHA)
SELECT DISTINCT COMPRA_NRO,CLIENTE_CODIGO,SUCURSAL_CODIGO,COMPRA_FECHA
